...
public class LimelightSettings
{
   ...
   */
  private final DoubleArrayEntry  cropWindow;
  /**
   ...
   */
  private final DoubleArrayEntry  fiducial3DOffset;
  /**
   ...
   */
  private final DoubleArrayEntry robotOrientationSet;
  /**
   * DoubleArray of valid apriltag id's to track.
   */
  private final DoubleArrayEntry fiducialIDFiltersOverride;
  /**
